...
class TestCreate:
    def test_randn(self):
        import dsp
        a = dsp.ops.randn(100, dtype=dsp.core.bint16)
        assert isinstance(a, dsp.core.DSPTensor)
        assert isinstance(a, torch.Tensor)
        assert a.dsp_dtype == dsp.core.bint16
        assert a.shape == (100,)

    def test_zeros(self):
        import dsp
        a = dsp.ops.zeros(10, dtype=dsp.core.double)
        assert a.dsp_dtype == dsp.core.double
    ...
    def test_from_torch(self):
        import dsp
        t = torch.randn(50)
        a = dsp.ops.from_torch(t, dtype=dsp.core.double)
        assert a.dsp_dtype == dsp.core.double
        assert a.shape == (50,)
...
class TestTorchCompat:
    ...
    def test_indexing(self):
        import dsp
        a = dsp.ops.randn(100, dtype=dsp.core.double)
        b = a[10:20]
        assert b.shape == (10,)

    def test_shape_device(self):
        import dsp
        a = dsp.ops.randn(3, 4, dtype=dsp.core.double)
        assert a.shape == (3, 4)
...
class TestDtypePropagation:
    ...
    def test_add_preserves_dtype(self, int16_pair):
        ...
        if isinstance(c, dsp.core.DSPTensor):
            assert c.dsp_dtype == dsp.core.bint16
    ...
    def test_abs_preserves_dtype(self):
        ...
        if isinstance(b, dsp.core.DSPTensor):
            assert b.dsp_dtype == dsp.core.double
...
class TestConversion:
    def test_torch_escape(self):
        ...
        import dsp
        a = dsp.ops.randn(10, dtype=dsp.core.bint16)
        t = a.torch()
    ...
    def test_fake_quantize(self):
        ...
        assert b.dsp_dtype == dsp.core.bint16
