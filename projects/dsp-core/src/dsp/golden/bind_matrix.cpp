...
void bind_matrix(py::module& m) {
    ...
    bind_linear<bint16, bint16, int32_t, bint16>(m, "dsp_linear_bint16_bint16_int32_bint16");
    bind_linear<bint16, bint16, int32_t, bint32>(m, "dsp_linear_bint16_bint16_int32_bint32");
    bind_linear<bint32, bint32, int32_t, bint32>(m, "dsp_linear_bint32_bint32_int32_bint32");
}
