...
inline void sp_vadd_int16(int16_t* dst, const int16_t* src0, const int16_t* src1, int count) {
    for (int i = 0; i < count; i++)
        dst[i] = static_cast<int16_t>(std::clamp(static_cast<int32_t>(src0[i]) + src1[i], -32768, 32767));
}
inline void sp_vadd_int32(int32_t* dst, const int32_t* src0, const int32_t* src1, int count) {
    for (int i = 0; i < count; i++)
